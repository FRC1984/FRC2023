package frc.lib.pixy.links;


import edu.wpi.first.wpilibj.SPI;
import frc.lib.pixy.Pixy2.Checksum;
...
public class SPILink implements Link {
	...
	public int open(int arg) {
		...
		//Is deprecated, removed without replacing
		//spi.setMSBFirst();

		//https://github.wpilib.org/allwpilib/docs/release/java/edu/wpi/first/wpilibj/SPI.html#setMode(edu.wpi.first.wpilibj.SPI.Mode)
